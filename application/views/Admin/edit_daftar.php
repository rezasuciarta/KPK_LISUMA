        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-lg-6">
              <form action="<?= base_url('Admin/edit_daftar/'. $anggota -> id_anggota); ?>" method="post">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nokta" name="nokta" value="<?= $anggota -> nokta ;?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="bidang" name="bidang" value="<?= $anggota -> bidang ;?>">
